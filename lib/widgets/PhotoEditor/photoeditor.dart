...
class _PhotoEditorState extends State<PhotoEditor> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<AspectRatioItem> _aspectRatios = <AspectRatioItem>[
      AspectRatioItem(
          text: getTranslated(context, 'custom'),
          value: CropAspectRatios.custom),
      AspectRatioItem(
          text: getTranslated(context, 'original'),
              ...
              children: [
                ...
                FlatButtonWithIcon(
                  ...
                  label: IsShowTextLabelsInPhotoVideoEditorPage == false
                      ? SizedBox()
                      : Text(
                          getTranslated(context, 'rotateleft'),
                          style: TextStyle(
                            fontSize: 8.0,
                            color: bottomIconColor,
                          ),
                ...
                FlatButtonWithIcon(
                  ...
                  label: IsShowTextLabelsInPhotoVideoEditorPage == false
                      ? SizedBox()
                      : Text(
                          getTranslated(context, 'rotateright'),
                          style: TextStyle(
                            fontSize: 8.0,
                            color: bottomIconColor,
                          ),
  ...
  Future<void> _cropImage(bool useNative) async {
    ...
    try {
      ...
      final String? filePath = await ImageSaver.save('temp.jpg', fileData!);
